...
export default function HeroBanner() {
    return (
        ...
        >
            <div className="flex w-1/2 flex-col items-center gap-4 px-10 sm:w-full">
                <h1 className="text-center text-6xl font-semibold sm:text-h-xl">
                    Revolutionize your{" "}
                    <span className="text-p-blue-1">Business</span> with a Focus
                    on Employee{" "}
                    <span className="text-s-orange-1">Mental Health</span>
                </h1>
