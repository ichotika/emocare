...
export default function RootLayout({ children }) {
    ...
    return (
        <div className="flex w-full bg-gradient-org xl:w-full xl:flex-col xl:bg-none">
            <div className="fixed left-0 top-0 flex h-screen w-[320px] flex-col justify-between px-6 pb-12 pt-12 text-white xl:static xl:h-auto xl:w-auto xl:px-0 xl:pb-0 xl:pt-0">
                <OrganizationSidebar menuRoutes={routesMenu} />
            </div>
            <div className="xl:rounded-tl-0 z-0 ml-[320px] min-h-screen grow rounded-tl-[40px] bg-white p-12 xl:ml-0 xl:grow-0 xl:bg-g-gray-5 xl:p-8">
                {children}
            </div>
        </div>
    );
